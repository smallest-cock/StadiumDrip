...
namespace Cvars
{
	...
	constexpr CvarData useSingleFreeplayColor = CVAR(
	    "use_single_freeplay_color", "use a single freeplay color instead of custom team colors");
	...
	constexpr CvarData showCarTurntable               = CVAR("show_car_turntable", "Show turntable underneath car in main menu");
	...
	constexpr CvarData carRotationPitch         = CVAR("car_rotation_pitch", "Main menu car pitch");
	constexpr CvarData carRotationYaw           = CVAR("car_rotation_yaw", "Main menu car yaw");
	constexpr CvarData carRotationRoll          = CVAR("car_rotation_roll", "Main menu car roll");
