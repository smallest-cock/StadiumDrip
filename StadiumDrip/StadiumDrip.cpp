...
void StadiumDrip::onLoad()
{
	...
	auto orangeTeamFieldColor_cvar =		RegisterCvar_Color(Cvars::orange_team_color,		"#FFF800");
	auto singleFreeplayColor_cvar =			RegisterCvar_Color(Cvars::single_freeplay_color,	"#FF2222");
	auto motd_color_cvar =					RegisterCvar_Color(Cvars::motd_single_color,		"#FF00FF");
	...
	DELAY(1.0f,
		auto blueTeamFieldColor_cvar = cvarManager->getCvar(Cvars::blue_team_color.name);
		auto orangeTeamFieldColor_cvar = cvarManager->getCvar(Cvars::orange_team_color.name);
		auto singleFreeplayColor_cvar = cvarManager->getCvar(Cvars::single_freeplay_color.name);
	...
	RegisterCommand(Commands::apply_motd,				std::bind(&StadiumDrip::cmd_changeMessageOfTheDay, this, std::placeholders::_1));
